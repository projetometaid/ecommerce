...
export class GTMService {
    ...
    trackBeginCheckout(productData) {
        ...
        this.pushEvent({
            ...
            ecommerce: {
                currency: 'BRL',
                value: productData.preco || 109.00,
                items: [{
                    ...
                    item_category3: 'A1',
                    price: productData.preco || 109.00,
                    quantity: 1
                }]
            }
        });
    ...
    trackAddPaymentInfo(paymentData, productData) {
        ...
        this.pushEvent({
            ...
            ecommerce: {
                currency: 'BRL',
                value: paymentData.valor || productData.preco || 109.00,
                payment_type: 'pix',
                items: [{
                    item_id: productData.codigo || 'ecpf-a1',
                    item_name: productData.nome || 'e-CPF A1 (1 ano)',
    ...
    trackPurchase(purchaseData) {
        ...
        this.pushEvent({
            ...
            ecommerce: {
                ...
                value: valor || productData.preco || 109.00,
                currency: 'BRL',
                tax: 0,
                shipping: 0,
                items: [{
    ...
    trackConversion(conversionLabel, conversionData) {
        this.pushEvent({
            ...
            value: conversionData.valor || 109.00,
            currency: 'BRL',
