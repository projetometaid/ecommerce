...
export class Step4View {
    ...
    getResumoHTML(data) {
        ...
        return `
            <div class="resumo-sections">
                ...
                ${this.getDadosPagadorHTML(pagador, mesmoPagador)}
    ...
    /**
     * Retorna HTML dos dados do pagador se for diferente do titular
     */
    getDadosPagadorHTML(pagador, mesmoPagador) {
        if (mesmoPagador || !pagador.dados) {
            return '';
        }
